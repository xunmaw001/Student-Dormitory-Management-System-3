...
public class HouqinrenyuanController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		HouqinrenyuanEntity user = houqinrenyuanService.selectOne(new EntityWrapper<HouqinrenyuanEntity>().eq("houqinzhanghao", username));
    ...
    public R register(@RequestBody HouqinrenyuanEntity houqinrenyuan){
    	...
    	HouqinrenyuanEntity user = houqinrenyuanService.selectOne(new EntityWrapper<HouqinrenyuanEntity>().eq("houqinzhanghao", houqinrenyuan.getHouqinzhanghao()));
		if(user!=null) {
