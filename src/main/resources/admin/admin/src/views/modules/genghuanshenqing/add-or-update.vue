<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="原宿舍号" prop="yuansushehao">
          <el-select :disabled="ro.yuansushehao" v-model="ruleForm.yuansushehao" placeholder="请选择原宿舍号">
            <el-option
                v-for="(item,index) in yuansushehaoOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="原宿舍号" prop="yuansushehao">
	      <el-input v-model="ruleForm.yuansushehao"
                placeholder="原宿舍号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="新宿舍号" prop="xinsushehao">
          <el-select :disabled="ro.xinsushehao" v-model="ruleForm.xinsushehao" placeholder="请选择新宿舍号">
            <el-option
                v-for="(item,index) in xinsushehaoOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="新宿舍号" prop="xinsushehao">
	      <el-input v-model="ruleForm.xinsushehao"
                placeholder="新宿舍号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      this.$http({
		...
		if(json.zhaopian!=''&&json.zhaopian){
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/sushefenpei/sushehao`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.yuansushehaoOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
            ...
            this.$http({
              ...
              if (data && data.code === 0) {
                this.xinsushehaoOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
