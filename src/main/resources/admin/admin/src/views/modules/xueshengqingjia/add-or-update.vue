<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.qingjiazhaopian" label="请假照片" prop="qingjiazhaopian">
          <file-upload
          tip="点击上传请假照片"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.qingjiazhaopian?ruleForm.qingjiazhaopian:''"
          @change="qingjiazhaopianUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.qingjiazhaopian" label="请假照片" prop="qingjiazhaopian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.qingjiazhaopian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
	...
	this.ruleForm.qingjiayuanyin = this.ruleForm.qingjiayuanyin.replace(reg,'../../../springbootn73cv/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
	...
	if(this.ruleForm.qingjiazhaopian!=null) {
		this.ruleForm.qingjiazhaopian = this.ruleForm.qingjiazhaopian.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
    ...
    qingjiazhaopianUploadChange(fileUrls) {
	this.ruleForm.qingjiazhaopian = fileUrls;
	this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
