    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="拾得地址" prop="shidedizhi">
          <el-input v-model="ruleForm.shidedizhi" 
              placeholder="拾得地址" clearable  :readonly="ro.shidedizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="拾得地址" prop="shidedizhi">
              <el-input v-model="ruleForm.shidedizhi" 
                placeholder="拾得地址" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="认领地址" prop="renlingdizhi">
          <el-input v-model="ruleForm.renlingdizhi" 
              placeholder="认领地址" clearable  :readonly="ro.renlingdizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="认领地址" prop="renlingdizhi">
              <el-input v-model="ruleForm.renlingdizhi" 
                placeholder="认领地址" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="物品描述" prop="wupinmiaoshu">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.wupinmiaoshu" label="物品描述" prop="wupinmiaoshu">
                    <span v-html="ruleForm.wupinmiaoshu"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.wupinmiaoshu = this.ruleForm.wupinmiaoshu.replace(reg,'../../../springbootn73cv/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
