<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="处理日期" prop="chuliriqi">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.chuliriqi" label="处理日期" prop="chuliriqi">
              <el-input v-model="ruleForm.chuliriqi" 
                placeholder="处理日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" label="处理状态" prop="chulizhuangtai">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="后勤账号" prop="houqinzhanghao">
          <el-input v-model="ruleForm.houqinzhanghao" 
              placeholder="后勤账号" clearable  :readonly="ro.houqinzhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="后勤账号" prop="houqinzhanghao">
              <el-input v-model="ruleForm.houqinzhanghao" 
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="处理简述" prop="chulijianshu">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.chulijianshu" label="处理简述" prop="chulijianshu">
                    <span v-html="ruleForm.chulijianshu"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      this.$http({
		...
		if(json.houqinzhanghao!=''&&json.houqinzhanghao){
                this.ruleForm.houqinzhanghao = json.houqinzhanghao
	    		this.ro.houqinzhanghao = true;
		}
		if(json.houqinxingming!=''&&json.houqinxingming){
                this.ruleForm.houqinxingming = json.houqinxingming
	    		this.ro.houqinxingming = true;
		}
		if(json.lianxidianhua!=''&&json.lianxidianhua){
          ...
          this.$message.error(data.msg);
            ...
            this.chulizhuangtaiOptions = "已修好,进行中".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
	...
	this.ruleForm.chulijianshu = this.ruleForm.chulijianshu.replace(reg,'../../../springbootn73cv/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
