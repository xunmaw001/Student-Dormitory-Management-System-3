  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" label="申请编号" prop="shenqingbianhao">
              <el-input v-model="ruleForm.shenqingbianhao" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="原宿舍号" prop="yuansushehao">
          <el-input v-model="ruleForm.yuansushehao" 
              placeholder="原宿舍号" clearable  :readonly="ro.yuansushehao"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="新宿舍号" prop="xinsushehao">
          <el-input v-model="ruleForm.xinsushehao" 
              placeholder="新宿舍号" clearable  :readonly="ro.xinsushehao"></el-input>
        </el-form-item>
        <div v-else>
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `shenqingtijiao/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.shenqingtijiaoCrossAddOrUpdateFlag = false;
						 this.parent.search();
