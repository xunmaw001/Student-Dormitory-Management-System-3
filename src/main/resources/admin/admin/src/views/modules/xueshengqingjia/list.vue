        ...
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
		    ...
		    label="宿舍号">
		     <template slot-scope="scope">
                  ...
                  <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign"  prop="qingjiazhaopian"
                   :header-align="contents.tableAlign"
                    width="200"
                    label="请假照片">
                    <template slot-scope="scope">
                      <div v-if="scope.row.qingjiazhaopian">
                        <img :src="$base.url+scope.row.qingjiazhaopian.split(',')[0]" width="100" height="100">
                      </div>
                      <div v-else>无图片</div>
                    </template>
                  </el-table-column>
    ...
    shDialog(row){
      ...
      if(row){
        this.shForm = {
          ...
          qingjiazhaopian: row.qingjiazhaopian,
