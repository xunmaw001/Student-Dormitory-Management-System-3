<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="入学日期" prop="ruxueriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.ruxueriqi" 
                type="date"
                :readonly="ro.ruxueriqi"
                placeholder="入学日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.ruxueriqi" label="入学日期" prop="ruxueriqi">
              <el-input v-model="ruleForm.ruxueriqi" 
                placeholder="入学日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.ruxueriqi = this.getCurDate()
