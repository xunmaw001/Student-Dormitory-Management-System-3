    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="相关描述" prop="xiangguanmiaoshu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="相关描述"
                  v-model="ruleForm.xiangguanmiaoshu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xiangguanmiaoshu" label="相关描述" prop="xiangguanmiaoshu">
                    <span>{{ruleForm.xiangguanmiaoshu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="详细情况" prop="xiangxiqingkuang">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.xiangxiqingkuang" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xiangxiqingkuang" label="详细情况" prop="xiangxiqingkuang">
                    <span v-html="ruleForm.xiangxiqingkuang"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	diushididian : false,
	diushishijian : false,
	xiangguanmiaoshu : false,
	xiangxiqingkuang : false,
	fabushijian : false,
	xuehao : false,
	xingming : false,
	shouji : false,
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.diushishijian = true;
          ...
          if(o=='xiangguanmiaoshu'){
            this.ruleForm.xiangguanmiaoshu = obj[o];
	    this.ro.xiangguanmiaoshu = true;
            continue;
          }
          if(o=='xiangxiqingkuang'){
            this.ruleForm.xiangxiqingkuang = obj[o];
	    this.ro.xiangxiqingkuang = true;
            continue;
          }
          if(o=='fabushijian'){
	...
	this.ruleForm.xiangxiqingkuang = this.ruleForm.xiangxiqingkuang.replace(reg,'../../../springbootn73cv/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
