<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="楼栋编号" prop="loudongbianhao">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="宿舍数量" prop="susheshuliang">
          <el-input v-model="ruleForm.susheshuliang" 
              placeholder="宿舍数量" clearable  :readonly="ro.susheshuliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="宿舍数量" prop="susheshuliang">
              <el-input v-model="ruleForm.susheshuliang" 
                placeholder="宿舍数量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="宿管账号" prop="suguanzhanghao">
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.suguanzhanghao" label="宿管账号" prop="suguanzhanghao">
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="安排时间" prop="anpaishijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.anpaishijian" label="安排时间" prop="anpaishijian">
              <el-input v-model="ruleForm.anpaishijian" 
                placeholder="安排时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.anpaishijian = this.getCurDate()
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.weizhi = true;
          ...
          if(o=='susheshuliang'){
            this.ruleForm.susheshuliang = obj[o];
	    this.ro.susheshuliang = true;
            continue;
          }
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `loudongxinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.loudongxinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
